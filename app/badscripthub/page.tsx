        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              const theme = currentTheme || THEME_PRESETS["landing"]
              const scriptColor = theme.AccentColor || "rgb(59, 130, 246)"
              return (
              <div
                key={i}
                ...
                style={{
                  backgroundColor: (theme.SurfaceColor || "rgb(23, 23, 23)").replace("rgb", "rgba").replace(")", ", 0.5)"),
                  borderColor: theme.BorderColor || "rgb(38, 38, 38)",
                ...
                onMouseLeave={(e: any) => {
                  e.currentTarget.style.borderColor = theme.BorderColor || "rgb(38, 38, 38)"
                  e.currentTarget.style.boxShadow = "none"
                }}
              >
